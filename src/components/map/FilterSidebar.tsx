    ...
    <div className="w-80 bg-white border-r border-slate-200 flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 border-b border-slate-200">
        ...
        <div className="grid grid-cols-4 gap-1.5">
          <button onClick={onUploadClick} className="flex flex-col items-center gap-1 py-2 px-1 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors">
            <div className="w-6 h-6 rounded bg-emerald-500 flex items-center justify-center"><ArrowUpFromLine className="w-3.5 h-3.5 text-white" /></div>
            <div className="text-[10px] font-semibold text-emerald-700">Upload</div>
          </button>
          <button onClick={onDatasetSwitch} className="flex flex-col items-center gap-1 py-2 px-1 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
            <div className="w-6 h-6 rounded bg-blue-500 flex items-center justify-center"><Layers className="w-3.5 h-3.5 text-white" /></div>
            <div className="text-[10px] font-semibold text-blue-700">Dataset</div>
          </button>
          <button onClick={onExportCsv} className="flex flex-col items-center gap-1 py-2 px-1 bg-amber-50 hover:bg-amber-100 rounded-lg transition-colors">
            <div className="w-6 h-6 rounded bg-amber-500 flex items-center justify-center"><FileDown className="w-3.5 h-3.5 text-white" /></div>
            <div className="text-[10px] font-semibold text-amber-700">CSV</div>
          </button>
          {onExportExcel && (
            <button onClick={onExportExcel} className="flex flex-col items-center gap-1 py-2 px-1 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
              <div className="w-6 h-6 rounded bg-green-600 flex items-center justify-center"><Table2 className="w-3.5 h-3.5 text-white" /></div>
              <div className="text-[10px] font-semibold text-green-700">Excel</div>
            </button>
          )}
        </div>
      </div>
